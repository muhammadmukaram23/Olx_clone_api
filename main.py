...
@app.get("/categories/parent", response_model=List[schemas.Category])
def read_parent_categories(db: Session = Depends(get_db)):
    categories = crud.get_parent_categories(db)
    return categories

@app.get("/categories/{category_id}/subcategories", response_model=List[schemas.Category])
...
@app.get("/ads/search", response_model=List[schemas.AdResponse])
...
@app.get("/ads/user/{user_id}", response_model=List[schemas.AdResponse])
...
@app.get("/ads/category/{category_id}", response_model=List[schemas.AdResponse])
...
@app.get("/ads/location/{location_id}", response_model=List[schemas.AdResponse])
...
@app.put("/ads/{ad_id}", response_model=schemas.AdResponse)
...
# AD IMAGE ENDPOINTS
@app.post("/ad-images/", response_model=schemas.AdImage)
...
@app.get("/users/{user_id}/favorites", response_model=List[schemas.Favorite])
...
@app.delete("/favorites/{user_id}/{ad_id}")
...
@app.get("/favorites/{user_id}/{ad_id}")
...
@app.get("/ads/{ad_id}/messages", response_model=List[schemas.Message])
...
@app.get("/conversations/{user1_id}/{user2_id}/{ad_id}", response_model=List[schemas.Message])
...
@app.get("/ads/{ad_id}/reports", response_model=List[schemas.Report])
...
@app.get("/users/{user_id}/transactions/buyer", response_model=List[schemas.Transaction])
...
@app.get("/users/{user_id}/transactions/seller", response_model=List[schemas.Transaction])
